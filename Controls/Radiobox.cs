...
namespace XorNet.Rose.Controls
{
	...
	class Radiobox : Control
	{
		...
		[Category("Appearance")]
		[DXDescription("Value of Radio")]
		public bool Group
		{
			get { return m_bGroup; }
			set
			{
				m_parent.Editor.UndoRedoManager.Update(this, m_bGroup, "Group", ExternalUpdateDerivative); 
				m_bGroup = value;
			}
		}
		#endregion
		...
		public override void Save(ref ControlProperty prop)
		{
			...
			prop.m_style |= WindowStyle.WBS_RADIO;
		...
		{
			return ((Radiobox)instance).InternalUpdateDerivative(data, identifier);
		}
